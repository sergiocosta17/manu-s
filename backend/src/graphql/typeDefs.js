...
const typeDefs = gql`
  ...
  input OrderItemInput { product: ID! quantity: Int! }
  input OrderInput { items: [OrderItemInput!]! total: Float! }
  ...
  type Mutation {
    ...
    updateProfile(name: String, phone: String, birthDate: String, avatarUrl: String, storeName: String, pickupAddress: String, addresses: String): User!
